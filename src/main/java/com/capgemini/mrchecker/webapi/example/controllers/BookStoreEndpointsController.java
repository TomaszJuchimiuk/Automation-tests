...
//		AllBooksModel books = getFromHost(IMFA_ZDI.getValue(), Endpoints.BOOKSTORE_GET_ALL_BOOKS_ENDPOINT.getEndpoint())
...
//		BookModel bookDetails = getFromHost(IMFA_ZDI.getValue(), Endpoints.BOOKSTORE_GET_BOOK_DETAILS_ENDPOINT.getEndpoint(isbn))
//				.as(BookModel.class);
...
//		};
//
//		AddedListOfBooksModel response = postToHost(IMFA_ZDI.getValue(), Endpoints.BOOKSTORE_ADD_LIST_OF_BOOKS_ENDPOINT.getEndpoint(), booksList, 201)
...
//		ExtractableResponse response = deleteFromHost(IMFA_ZDI.getValue(), Endpoints.BOOKSTORE_REMOVE_LIST_OF_BOOKS_FOR_USER_ENDPOINT.getEndpoint(userID), 204);
//		assertNotNull(response, "No response was returned");
//	}
//}
